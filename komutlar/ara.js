...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (message.channel.activeCollector)
      return message.reply("Bu kanalda zaten bir arama aktif.");
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setDescription(`**${search}** aramasıyla ilgili sonuçlar`)
      .setColor("#F8AA2A");
    ...
    try {
      ...
      message.client.commands.get("çal").execute(message, [choice]);
